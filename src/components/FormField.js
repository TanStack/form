...
function FormField(FormComponent) {
  class ConnectedFormField extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState, nextContext) {
      ...
      // Use child props without children
      const nonChildrenProps = { ...this.props, children: false };
      const nextNonChildrenProps = { ...nextProps, children: false };
      ...
      const shouldUpdate =
        ...
        !Utils.isShallowEqual(nonChildrenProps, nextNonChildrenProps) ||
        nextContext.formApi.submits !== this.context.formApi.submits;
