...
import { Form, FormError, Text, Select, Textarea, Checkbox, RadioGroup, Radio, NestedForm } from '../src/index'
    ...
    <div>
      ...
      >
        {({ values, errors, touched, nestedErrors, dirty, submitForm, addValue, removeValue, getError }) => {
          ...
          return (
            <form onSubmit={submitForm}> {/* When the form is submitted, call the `sumbitForm` callback prop */}
              <div>
                <h6>Full Name</h6>
