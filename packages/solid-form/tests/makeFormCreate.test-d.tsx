...
import { makeFormCreate, makeFormCreateContexts } from '../src'
import type { JSX } from 'solid-js/jsx-runtime'

const { fieldContext, useFieldContext, formContext, useFormContext } =
  makeFormCreateContexts()

function Test() {
  return null
}

const { createAppForm, withForm } = makeFormCreate({
  fieldComponents: {
    Test,
  },
  formComponents: {
...
describe('makeFormCreate', () => {
  ...
  it("component made from withForm should have it's props properly typed", () => {
    ...
    const appForm = createAppForm(() => formOpts)
    ...
    const incorrectAppForm = createAppForm(() => incorrectFormOpts)
