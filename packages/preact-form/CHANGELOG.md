...
- fix(preact-form): prevent array field re-render when child property changes ([#1930](https://github.com/TanStack/form/pull/1930))
...
- fix(preact-form): ensure `FormApi.handleSubmit` returns a promise again ([#1924](https://github.com/TanStack/form/pull/1924))
...
- Update Start to Release Candidate version. Extracted start, remix and nextJs adapters to the respective libraries @tanstack/preact-form-start, @tanstack/preact-form-remix, and @tanstack/preact-form-nextjs, ([#1771](https://github.com/TanStack/form/pull/1771))
