...
Defined in: [listeners.public.ts:43](https://github.com/TanStack/form-v2/blob/main/packages/form-core/src/listeners.public.ts#L43)
...
```ts
optional triggers: ListenerTriggerOption<TTriggers, TFormData, TValue>[];
```
