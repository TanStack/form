...
Defined in: [validation.public.ts:358](https://github.com/TanStack/form-v2/blob/main/packages/form-core/src/validation.public.ts#L358)

## Extends

- [`Validator`](Validator.md)\<`TGroupValue`, 
  \| [`FormGroupValidatorFn`](../type-aliases/FormGroupValidatorFn.md)\<`TGroupValue`\>
  \| [`StandardSchemaV1`](../type-aliases/StandardSchemaV1.md)\<`TGroupValue`, `any`\>, `TGroupValue`\>
...
```ts
triggers: ValidationTriggerOption<TGroupValue, TGroupValue>[];
```
