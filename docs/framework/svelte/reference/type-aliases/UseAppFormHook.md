...
Defined in: [packages/svelte-form/src/AppForm/createFormHookTypes.public.ts:11](https://github.com/LeCarbonator/tanstack-form/blob/main/packages/svelte-form/src/AppForm/createFormHookTypes.public.ts#L11)
...
[`SvelteAppFormApi`](SvelteAppFormApi.md)\<`TFormData`, `ToFormErrorTypes`\<`TFormValidators`, `TSubmitReturn`\>, `TComponents`\>
