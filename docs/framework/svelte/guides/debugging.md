---
id: debugging
title: Debugging Svelte Usage
---

This page covers common Svelte and TypeScript problems when using TanStack
Form.
...
the TypeScript and Svelte versions, the form value type, and the smallest
failing field.
