...
Defined in: [get-form-type.ts:75](https://github.com/LeCarbonator/tanstack-form/blob/main/packages/lit-form/src/get-form-type.ts#L75)
...
[`LitFormType`](../type-aliases/LitFormType.md)\<`TOptions`\>
