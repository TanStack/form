...
Defined in: [packages/preact-form/src/PreactForm/formType.public.ts:56](https://github.com/LeCarbonator/tanstack-form/blob/main/packages/preact-form/src/PreactForm/formType.public.ts#L56)
