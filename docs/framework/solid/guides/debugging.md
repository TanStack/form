---
id: debugging
title: Debugging Solid Usage
---

This page covers common Solid and TypeScript problems when using TanStack Form.

## An input does not start with the expected value

Every value rendered by an input should exist in form-level `defaultValues`
...
the TypeScript and Solid versions, the form value type, and the smallest failing
field.
