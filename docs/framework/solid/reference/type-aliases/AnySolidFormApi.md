...
Defined in: [packages/solid-form/src/formApiTypes.public.ts:52](https://github.com/TanStack/form/blob/main/packages/solid-form/src/formApiTypes.public.ts#L52)
