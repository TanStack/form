...
Defined in: [packages/solid-form/src/formApiTypes.public.ts:16](https://github.com/TanStack/form/blob/main/packages/solid-form/src/formApiTypes.public.ts#L16)
