...
Defined in: [packages/solid-form/src/formType.public.ts:50](https://github.com/LeCarbonator/tanstack-form/blob/main/packages/solid-form/src/formType.public.ts#L50)
