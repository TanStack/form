...
- [`VueFormComponentMap`](VueFormComponentMap.md)\<`TFormComponents`, `TFieldComponents`\>
...
Defined in: [packages/vue-form/src/AppForm/createFormHookTypes.public.ts:79](https://github.com/TanStack/form/blob/main/packages/vue-form/src/AppForm/createFormHookTypes.public.ts#L79)
...
Defined in: [packages/vue-form/src/AppForm/createFormHookTypes.public.ts:95](https://github.com/TanStack/form/blob/main/packages/vue-form/src/AppForm/createFormHookTypes.public.ts#L95)
...
Defined in: [packages/vue-form/src/AppForm/createFormHookTypes.public.ts:64](https://github.com/TanStack/form/blob/main/packages/vue-form/src/AppForm/createFormHookTypes.public.ts#L64)
...
Defined in: [packages/vue-form/src/AppForm/componentMap.public.ts:8](https://github.com/TanStack/form/blob/main/packages/vue-form/src/AppForm/componentMap.public.ts#L8)

#### Inherited from

[`VueFormComponentMap`](VueFormComponentMap.md).[`fieldComponents`](VueFormComponentMap.md#fieldcomponents)
...
Defined in: [packages/vue-form/src/AppForm/componentMap.public.ts:7](https://github.com/TanStack/form/blob/main/packages/vue-form/src/AppForm/componentMap.public.ts#L7)

#### Inherited from

[`VueFormComponentMap`](VueFormComponentMap.md).[`formComponents`](VueFormComponentMap.md#formcomponents)
