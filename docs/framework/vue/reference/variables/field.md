...
FieldApiOptions\<TParentData, TName, TFieldValidator, TFormValidator, TData, never\> & \{ ...; \} & (\{ ...; \} \| \{ ...; \}) & `VNodeProps` & `AllowedComponentProps` & `ComponentCustomProps`
